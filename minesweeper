    ...
    def draw_status(self):
        ...
        if 2 * self.cols + 19 <= curses.COLS:
            ...
            if curses.LINES >= 21:
                ...
                self.stdscr.addstr(13, 2 * self.cols + 3, Game.symbols['1'] + "  1 nearby mine")
                self.stdscr.addstr(14, 2 * self.cols + 3, Game.symbols['2'] + "  2 nearby mines")
                self.stdscr.addstr(15, 2 * self.cols + 3, Game.symbols['3'] + "  3 nearby mines")
                self.stdscr.addstr(16, 2 * self.cols + 3, Game.symbols['4'] + "  4 nearby mines")
                self.stdscr.addstr(17, 2 * self.cols + 3, Game.symbols['5'] + "  5 nearby mines")
                self.stdscr.addstr(18, 2 * self.cols + 3, Game.symbols['6'] + "  6 nearby mines")
                self.stdscr.addstr(19, 2 * self.cols + 3, Game.symbols['7'] + "  7 nearby mines")
                self.stdscr.addstr(20, 2 * self.cols + 3, Game.symbols['8'] + "  8 nearby mines")
        self.stdscr.move(*curr_pos)
