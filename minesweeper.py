    ...
    def draw_status(self):
        ...
        if 2 * self.cols + 19 <= curses.COLS:
            ...
            if curses.LINES >= 14:
                ...
                # self.stdscr.addstr(14, 2 * self.cols + 3, Game.symbols['1'] + "  1 nearby mine")
                # self.stdscr.addstr(15, 2 * self.cols + 3, Game.symbols['2'] + "  2 nearby mines")
                # self.stdscr.addstr(16, 2 * self.cols + 3, Game.symbols['3'] + "  3 nearby mines")
                # self.stdscr.addstr(17, 2 * self.cols + 3, Game.symbols['4'] + "  4 nearby mines")
                # self.stdscr.addstr(18, 2 * self.cols + 3, Game.symbols['5'] + "  5 nearby mines")
                # self.stdscr.addstr(19, 2 * self.cols + 3, Game.symbols['6'] + "  6 nearby mines")
                # self.stdscr.addstr(20, 2 * self.cols + 3, Game.symbols['7'] + "  7 nearby mines")
                # self.stdscr.addstr(21, 2 * self.cols + 3, Game.symbols['8'] + "  8 nearby mines")
        self.stdscr.move(*curr_pos)
        ...
        if self.board[row][col] == Game.symbols['MINE']:
            ...
            while len(queue) > 0:
                ...
                if self.display_board[curr_pos[0]][curr_pos[1]] == Game.symbols['FLAG']:
                    self.num_flags -= 1
                self.set(curr_pos[0], curr_pos[1], self.board[curr_pos[0]][curr_pos[1]], refresh=False)
